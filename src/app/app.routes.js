...
var routes = [
    { path: ':state', component: review_list_component_1.ReviewListComponent },
    { path: '', component: review_list_component_1.ReviewListComponent }
];
...
exports.SushipilgrimRouterModule = SushipilgrimRouterModule;
